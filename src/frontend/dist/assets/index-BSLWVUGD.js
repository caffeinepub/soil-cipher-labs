      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-16 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Leaf, { className: "w-5 h-5 text-forest-600" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sans text-xs font-semibold tracking-widest uppercase text-forest-600", children: "About Us" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "accent-line" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading text-forest-800 mb-6", children: "Where Agriculture Meets Insight, Innovation & Intelligence" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 body-text text-foreground/80", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "Soil isn't just dirt.",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              "It's a living, breathing ecosystem speaking a hidden language of minerals, nutrients, moisture, and microbial life."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "For decades, farming decisions have relied on approximation. But beneath every thriving crop lies untapped intelligence — waiting to be decoded." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "At",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-forest-700 font-semibold", children: "Soil Cipher Labs" }),
              ", we bridge traditional agricultural wisdom with modern science and AI-powered analytics. We analyze soil health, nutrient balance, and fertilizer efficiency to deliver clarity, precision, and measurable results."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Because when soil speaks — we listen."
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "linear-gradient(135deg, oklch(0.38 0.095 155) 0%, oklch(0.30 0.085 155) 100%)",
                padding: "3px"
              },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: [
                    {
                      icon: "🌱",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans font-semibold text-forest-800 text-sm", children: item.label }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-sm text-forest-600", children: item.desc })
                    ] })
                  ] }, item.label)) })
                }
              )
...
function CallToAction() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        background: "linear-gradient(135deg, oklch(0.15 0.04 155) 0%, oklch(0.22 0.065 155) 40%, oklch(0.28 0.07 50) 100%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-4xl mx-auto text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading text-cream-200 mb-8", children: "Transform the Way We Nurture the Land — One Insight at a Time." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 mb-12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-base text-cream-400", children: "The future of farming begins beneath your feet." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "font-serif italic text-lg font-semibold",
                style: { color: "oklch(0.75 0.08 155)" },
                children: "Let's decode your soil."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "font-serif italic text-lg font-semibold",
                style: { color: "oklch(0.75 0.08 155)" },
                children: "Let's optimize your fertilizers."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "font-serif italic text-lg font-semibold",
                style: { color: "oklch(0.75 0.08 155)" },
                children: "Let's build resilient agriculture."
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                children: "Request Soil Analysis"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                children: "Partner With Soil Cipher Labs"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading text-cream-200 mb-4", children: "Traditional Farming Shouldn't Be Guesswork." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "body-text text-cream-400 max-w-2xl mx-auto", children: "Across agricultural ecosystems, we see persistent challenges that cost farmers their livelihoods and the land its vitality." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-12", children: [
          painPoints.map((point) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl flex-shrink-0", children: point.icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans font-medium text-cream-300 text-sm leading-snug pt-1", children: point.text })
              ]
            },
            point.text
          )),
            ...
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  style: { color: "oklch(0.83 0.1 65)" },
                  children: "Without accurate soil intelligence, farmers are forced to make costly assumptions."
                }
              )
            }
          )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            style: { color: "oklch(0.83 0.1 65)" },
            children: "And assumptions reduce profitability."
          }
        ) })
      ] })
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-5 h-5 text-forest-600" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sans text-xs font-semibold tracking-widest uppercase text-forest-600", children: "Contact" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "accent-line mx-auto" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading text-forest-800 mb-4", children: "Get In Touch" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "body-text text-foreground/70 max-w-xl mx-auto", children: "Ready to decode your soil? Reach out to us and let's start the conversation." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-10 items-start", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-xs font-semibold tracking-widest uppercase text-foreground/50 mb-1", children: "Email" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "a",
                      {
                        ...
                        children: "info@soilcipherlabs.com"
                      }
                    )
                  ] })
                ]
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-xs font-semibold tracking-widest uppercase text-foreground/50 mb-1", children: "Phone" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "a",
                      {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-5 h-5" })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-xs font-semibold tracking-widest uppercase text-foreground/50 mb-1", children: "Location" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-base font-medium text-foreground/80", children: "India" })
                  ] })
                ]
              }
            )
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-xs font-semibold tracking-widest uppercase text-foreground/50 mb-6", children: "Follow the Conversation" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: hashtags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hashtag-tag", children: tag }, tag)) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif italic text-base text-foreground/60 leading-relaxed", children: '"The future of agriculture depends on understanding what lies beneath the surface."' }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-sm font-semibold text-forest-600 mt-3", children: "— Vardhamana Indori, Founder" })
                    ]
                  }
                )
              ]
    ...
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-sans text-xs text-cream-400 text-center", children: [
            "© ",
            year,
            " Soil Cipher Labs. All rights reserved."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-sans text-xs text-cream-400 flex items-center gap-1.5", children: [
            "Built with",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Heart,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: ["#about", "#solution", "#services", "#impact", "#contact"].map(
...
function Founder() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3 mb-12 justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sans text-xs font-semibold tracking-widest uppercase text-forest-600", children: "Founder Message" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center md:justify-start", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: "absolute -inset-3 rounded-full opacity-20",
                style: {
                  background: "conic-gradient(from 0deg, oklch(0.38 0.095 155), oklch(0.72 0.12 65), oklch(0.38 0.095 155))"
                }
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "accent-line" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-3xl md:text-4xl font-bold text-forest-800 mb-2", children: "Vardhamana Indori" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-sm text-foreground/60 mb-8 leading-relaxed", children: "Agri-Strategist  |  Sustainable Farming Advocate  |  Soil Intelligence Innovator" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif italic text-lg text-forest-800 leading-relaxed", children: '"Beneath every thriving crop lies an untold story — written in minerals, nutrients, moisture, and microbial life. When we understand that story, we unlock the true potential of the land."' })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-base text-foreground/75 leading-relaxed mb-3", children: "Soil Cipher Labs was born from a simple belief:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "font-serif italic text-lg font-semibold",
                style: { color: "oklch(0.38 0.095 155)" },
                children: "The future of agriculture depends on understanding what lies beneath the surface."
              }
            )
          ] })
        ] })
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-cream-200/95 backdrop-blur-md shadow-soil border-b border-forest-100" : "bg-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 md:px-10 flex items-center justify-between h-16 md:h-20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#hero", className: "flex items-center group", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: "/assets/logo.jpeg",
              alt: "Soil Cipher Labs",
              className: `h-12 md:h-14 w-auto object-contain transition-all duration-300 ${scrolled ? "brightness-100" : "brightness-110 drop-shadow-lg"}`
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden md:flex items-center gap-8", children: [
            navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                href: link.href,
                className: `font-sans text-sm font-medium tracking-wide transition-colors hover:text-forest-400 ${scrolled ? "text-forest-700" : "text-cream-300"}`,
                children: link.label
              },
              link.href
            )),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#contact", className: "btn-primary text-xs px-5 py-2.5", children: "Get Started" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              className: `md:hidden p-2 rounded-sm transition-colors ${scrolled ? "text-forest-700" : "text-cream-200"}`,
        ...
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden bg-cream-200/98 backdrop-blur-md border-t border-forest-100 px-6 py-6 flex flex-col gap-4", children: [
          navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: link.href,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(135deg, oklch(0.15 0.04 155 / 0.88) 0%, oklch(0.12 0.03 60 / 0.82) 60%, oklch(0.18 0.05 50 / 0.75) 100%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-5xl mx-auto px-6 md:px-12 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-cream-400/30 bg-cream-200/10 backdrop-blur-sm mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sans text-xs font-medium tracking-widest uppercase text-cream-300", children: "Soil Intelligence Platform" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-serif text-4xl md:text-6xl lg:text-7xl font-bold text-cream-200 leading-tight mb-6", children: [
            "Soil Isn't Dirt.",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic", style: { color: "oklch(0.83 0.1 65)" }, children: "It's Intelligence" }),
            " ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              style: { color: "oklch(0.83 0.1 65)" },
              children: "Rooting for Success: Decoding the Secret Language of Soil and Fertilizers"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-base md:text-lg text-cream-400 max-w-2xl mx-auto mb-10 leading-relaxed", children: "At Soil Cipher Labs, we transform soil data into actionable intelligence — empowering farmers, agribusinesses, and agricultural leaders to make precise, profitable, and sustainable decisions." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: "font-serif italic text-sm md:text-base mb-10",
              style: { color: "oklch(0.75 0.08 155)" },
              children: "When you understand the roots, you empower the future."
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "#solution",
                className: "btn-primary text-sm px-8 py-4 w-full sm:w-auto",
                children: "Explore Soil Intelligence"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sans text-xs tracking-widest uppercase", children: "Scroll" }),
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-5 h-5 text-forest-600" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sans text-xs font-semibold tracking-widest uppercase text-forest-600", children: "Impact & Results" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "accent-line mx-auto" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading text-forest-800 mb-4", children: "When We Listen to the Soil, We Cultivate the Future." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "body-text text-foreground/70 max-w-2xl mx-auto", children: "With intelligent soil decoding, farmers achieve measurable, lasting results." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12", children: impacts.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: item.stat.startsWith("✓") ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "svg",
                      {
                        className: "w-5 h-5",
                        fill: "none",
                    ...
                    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold", children: "✓" })
                  }
                ),
                !item.stat.startsWith("✓") && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif font-bold text-forest-800 text-lg leading-snug", children: item.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-sm text-foreground/70 leading-relaxed", children: item.desc })
            ]
          },
          item.label
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-xl md:text-2xl font-semibold text-forest-800", children: "Understanding soil reduces cost, improves resilience, and increases profitability." })
          }
        )
      ] })
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FlaskConical, { className: "w-5 h-5 text-forest-600" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sans text-xs font-semibold tracking-widest uppercase text-forest-600", children: "Services" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "accent-line mx-auto" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading text-forest-800 mb-4", children: "Soil Intelligence Services" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "body-text text-foreground/70 max-w-2xl mx-auto", children: "A complete suite of data-driven services designed to decode your soil and optimize your agricultural outcomes." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: services.map((service) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif font-bold text-forest-800 text-lg mb-2 leading-snug", children: service.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-sm text-foreground/70 leading-relaxed", children: service.desc })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FlaskConical, { className: "w-5 h-5 text-forest-600" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sans text-xs font-semibold tracking-widest uppercase text-forest-600", children: "The Soil Cipher Solution" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "accent-line mx-auto" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading text-forest-800 mb-4", children: "Unlocking Underground Secrets." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "body-text text-foreground/70 max-w-2xl mx-auto", children: "Soil Cipher Labs offers a structured, data-driven approach to soil and fertilizer optimization." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-14", children: steps.map((step, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "card-soil group",
            style: idx === 4 ? { gridColumn: "span 1" } : {},
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "step-number flex-shrink-0", children: step.num }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif font-bold text-forest-800 text-lg mb-2 leading-snug", children: step.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-sm text-foreground/70 leading-relaxed", children: step.desc })
              ] })
            ] })
          },
          step.num
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-xs font-semibold tracking-widest uppercase text-cream-400 mb-5 text-center", children: "Intelligence Pipeline" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center justify-center gap-2 md:gap-0", children: pipeline.map((step, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                ...
                idx < pipeline.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-md overflow-hidden mb-10 border border-forest-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-2xl md:text-3xl font-bold text-forest-800", children: "We don't just test soil." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: "font-serif italic text-2xl md:text-3xl font-bold mt-1",
              style: { color: "oklch(0.38 0.095 155)" },
              children: "We decode it."
            }
          )
        ] })
      ] })
...
function VisionMission() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Globe,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading text-cream-200 mb-8 text-3xl md:text-4xl", children: "Transforming Agriculture Into a Knowledge-Driven Ecosystem." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-sm font-semibold tracking-widest uppercase text-cream-400 mb-5", children: "We envision a future where:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-4 mb-10", children: visionPoints.map((point) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sans text-base text-cream-300", children: point })
          ] }, point)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-serif italic text-cream-300 text-base leading-relaxed", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading text-cream-200 mb-8 text-3xl md:text-4xl", children: "Our Mission" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-base text-cream-300 leading-relaxed mb-10", children: "To empower farmers, agribusinesses, and institutions with clarity, precision, and actionable soil intelligence — creating resilient farms and sustainable agricultural ecosystems." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "rounded-md p-8",
              style: {
                background: "linear-gradient(135deg, oklch(0.38 0.095 155 / 0.2) 0%, oklch(0.22 0.065 155 / 0.3) 100%)",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    style: { color: "oklch(0.75 0.08 155)" },
                    children: "We cultivate more than crops."
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: cultivateLines.map((line, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading text-cream-200 mb-4", children: "Why Soil Cipher Labs?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "body-text text-cream-400 max-w-2xl mx-auto", children: "We combine technology, agriculture, and strategy — building the future of soil intelligence." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-14", children: usps.map((usp) => {
          const Icon2 = usp.icon;
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif font-bold text-cream-200 text-lg leading-snug", children: usp.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-sm text-cream-400 leading-relaxed", children: usp.desc })
              ]
            },
            usp.title
          );
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif italic text-xl md:text-2xl font-semibold text-cream-200", children: "We combine technology, agriculture, and strategy — building the future of soil intelligence." })
          }
        )
      ] })
    }
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Challenge, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Solution, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Impact, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center items-center py-12 px-4 bg-cream-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: "/assets/name.png",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(WhySoilCipher, {}),
